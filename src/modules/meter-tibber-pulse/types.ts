...
export function parseConfig(cfg: unknown): PulseConfig {
  ...
  return {
    ...
    ctrlTopics: Array.isArray(c.ctrlTopics) ? (c.ctrlTopics as string[]) : ['pctrl', 'pulse/subscribe'],
    disablePayload: typeof c.disablePayload === 'string' ? c.disablePayload : 'batching_disable true',
